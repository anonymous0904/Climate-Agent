...
#     wind_variability,gust_speed,lower_direction_variation,upper_direction_variation,cavok,horizontal_visibility,
#     present_phenomena_1,present_phenomena_2,present_phenomena_3,cloud_nebulosity_1,cloud_altitude_1,cb_1,
#     cloud_nebulosity_2,cloud_altitude_2,cb_2,cloud_nebulosity_3,cloud_altitude_3,cb_3,no_cloud,
#     vertical_visibility)
...
#     wind_direction, wind_speed, wind_variability, gust_speed, lower_direction_variation, upper_direction_variation,
...
#     cloud_altitude_3, cb_3, no_cloud, vertical_visibility) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,
...
def taf_parser(filename):
    ...
    for taf_code in taf_codes:
        ...
        datetime = parser.string_to_datetime(taf_elements[0:12])
        taf_elements = taf_elements[1:]
